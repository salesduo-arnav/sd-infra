      ...
      <div className="space-y-10">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary/10 via-primary/5 to-background p-8 md:p-12 border border-primary/10">
          <div className="relative z-10 max-w-2xl">
            <h1 className="text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl">
              {t('pages.apps.welcomeBack')} <span className="text-primary">{user?.full_name || "Seller"}</span>
            </h1>
            <p className="mt-4 text-lg text-muted-foreground">
              {t('pages.apps.heroDescription')}
            </p>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold tracking-tight">{t('pages.apps.yourApps')}</h2>
              <p className="text-muted-foreground mt-1">
                {t('pages.apps.launchDescription')}
              </p>
            </div>
          </div>
